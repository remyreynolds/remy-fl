...
GenreMixMap mixDefaultsFor (GenreMode genre)
{
    ...
    drum (DrumPiece::Ride, 0.55f);     // percussion pieces sit under the core kit
    drum (DrumPiece::Shaker, 0.50f);
    drum (DrumPiece::Rim, 0.55f);
    drum (DrumPiece::CongaHi, 0.60f);
    drum (DrumPiece::CongaLo, 0.60f);
